...
class fragment_one : Fragment() {
    ...
    override fun onCreateView(
        ...
        var textView : TextView = view.findViewById(R.id.navFirstView)
        textView.setOnClickListener { Navigation.findNavController(view).navigate(R.id.action_fragment_one_to_fragment_2) }
        return view
    }
